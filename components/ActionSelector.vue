<template>
  <div class="space-y-4">
      <div class="flex gap-4"><!-- Category Selection -->
      ...
      <div class="grid grid-cols-3 sm:grid-cols-3 gap-4">
        ...
        <!-- Bonus Input -->
        <div class="flex items-center space-x-2">
          <label for="bonus" class="flex grow text-slate-300 font-medium">
            Bonus:
          </label>
          <input
              id="bonus"
              ...
              step="1"
              placeholder="0"
              class="w-full p-2 bg-slate-700 border border-slate-600 rounded-md focus:ring-sky-500 focus:border-sky-500 text-slate-100 disabled:opacity-50 text-center"
          />
        </div>
      </div>
    </div>
